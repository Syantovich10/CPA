...
function HeroSection() {
  ...
  return (
    <Section
      padding="none"
      minHeight="none"
      className="relative isolate h-[calc(100dvh-44px)] min-h-[calc(100dvh-44px)] overflow-hidden text-white md:h-dvh md:min-h-dvh"
      background={
    ...
    >
      <div className="mx-auto w-full lg:max-w-[1440px] relative flex min-h-0 flex-1 flex-col px-[14px] pt-[100px] md:pt-[150px] lg:grid lg:grid-cols-[minmax(470px,0.9fr)_minmax(0,1.1fr)] lg:grid-rows-[1fr_auto] lg:px-[50px] lg:pt-[120px] lg:pb-[50px] xl:grid-cols-[minmax(560px,0.9fr)_minmax(0,1.1fr)]">
        ...
        <div className="-mx-[14px] mt-auto flex min-h-0 w-[calc(100%+28px)] flex-1 -translate-y-[70px] justify-end lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:mx-0 lg:-ml-[80px] lg:max-h-[calc(100dvh-170px)] lg:w-[calc(100%+80px)] lg:translate-x-[50px] lg:translate-y-0 lg:items-end xl:-ml-[120px] xl:w-[calc(100%+120px)]">
          <DecorativeArt
            mobileSrc={mobileSnake}
            desktopSrc={desktopSnake}
            alt={t('accessibility.heroSnake')}
            pictureClassName="flex h-full min-h-0 w-full items-end justify-end"
